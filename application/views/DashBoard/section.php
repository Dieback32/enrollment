...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header"><i class="fa fa fa-bars"></i>Section</h3>
			</div>
		</div>
		<!-- page start-->
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						<button class="btn btn-success" onclick="add_section()"><i class="glyphicon glyphicon-plus"></i>
							Add Section
						</button>
						<br>
										...
										<form action="#" id="form" class="form-horizontal">
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-9">
														<input name="section" placeholder="section" pattern="\d+"
												...
												<div class="form-group">
													<label class="control-label col-md-3">Max Student</label>
													<div class="col-md-9">
														<input name="max" placeholder="MAx" pattern="\d+"
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<select name="adviser" class="form-control" required="required">
															<?php foreach ($faculties as $faculty): ?>

																<option value="<?php echo $faculty['id']; ?>"><?php echo $faculty['first_name'] . ' ' . $faculty['last_name']; ?></option>
															<?php endforeach ?>
														</select>
													</div>
												</div>
...
<script type="text/javascript">
	...
	function add_section() {
		...
		$('.modal-title').text('Add Section'); // Set Title to Bootstrap modal title
	}
	...
	function edit_section(id) {
		...
		$.ajax({
			...
			success: function (data) {
				...
				$('.modal-title').text('Edit Section'); // Set title to Bootstrap modal title
