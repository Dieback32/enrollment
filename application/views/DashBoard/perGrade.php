...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<div class="col-md-4">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> Student Repdrt</h3>
				</div>
				<div class="col-md-4">
...
//											'sy' => $row->sy
//										))->result_array();
//										$syId = $this->db->get_where('sy', array('id' => @$sy[0]['id']))->result_array();
										?>
										<td>
											<a data-toggle="modal" href='#modal-<?php echo $row->user_id ?>'
											   class="btn btn-primary">View</a>
											<a data-toggle="modal"
											   href='<?php echo base_url() ?>index.php/grading/viewGrades?sy=<?php echo $row->sy ?>&id=<?php echo $row->user_id ?>'
