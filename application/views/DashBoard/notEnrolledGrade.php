...
<section id="main-content">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa fa-bars"></i> not Enrolled List</h3>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h3 class="modal-title">CATC notEnrolledGrade Form</h3>
                  </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <select name="role" class="form-control" readonly="readonly">
                              <option>notEnrolledGrade</option>
                              <option>staff</option>
                            </select>
                          </div>
                        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('notEnrolledGrade/ajax_list')?>",
          "type": "POST"
      },
  ...
  function edit_notEnrolledGrade(id)
  {
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    ...
    $.ajax({
      url : "<?php echo site_url('notEnrolledGrade/ajax_edit/')?>/" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data)
      {
          ...
          $('.modal-title').text('Edit notEnrolledGrade'); // Set title to Bootstrap modal title
  ...
  function save()
  {
    ...
    if(save_method == 'add') 
    {
        url = "<?php echo site_url('notEnrolledGrade/ajax_add')?>";
    }
    else
    {
      url = "<?php echo site_url('notEnrolledGrade/ajax_update')?>";
    }
  ...
  function delete_notEnrolledGrade(id)
  {
    if(confirm('Are you sure delete this data?'))
    {
      // ajax delete data to database
        $.ajax({
          url : "<?php echo site_url('notEnrolledGrade/ajax_delete')?>/"+id,
          type: "POST",
          dataType: "JSON",
          success: function(data)
          {
