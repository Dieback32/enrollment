...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header"><i class="fa fa fa-bars"></i> Requirements</h3>
			</div>
		</div>
		<!-- page start-->
		<div class="row">
									...
									<div class="modal-content">
										...
										<div class="modal-body form">
											<form action="#" id="form" class="form-horizontal">
												<!-- <input type="hidden" value="" name="nso"/> -->
												<div class="form-body">
													<div class="form-group">
														<label class="control-label col-md-3">NSO</label>
														<div class="col-md-9">
															<input name="nso" placeholder="NSO" class="form-control"
															       type="file">
														</div>
													</div>
													<div class="form-group">
