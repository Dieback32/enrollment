...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header"><i class="fa fa fa-bars"></i> Add Assistant Registrar</h3>
			</div>
		</div>
		<!-- page start-->
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						...
						?>
						<form method="POST" id="addAccount" action="<?php echo site_url(); ?>/DashBoard/setTreasurer"
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input name="role" type="hidden" value="asstreg">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input value="<?php echo set_value('lname') ?>" name="lname" pattern="[A-Za-z]+"
										       class="form-control" id="" placeholder="Lastname" required>
										<div class="help-block with-errors"></div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input value="<?php echo set_value('fname') ?>" type="text" name="fname"
										       class="form-control" id="" pattern="[A-Za-z]+" placeholder="First name"
										       required>
										<div class="help-block with-errors"></div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input value="<?php echo set_value('contact') ?>" name="contact"
										       pattern="^\d{11}$" maxlength="11" type="text" class="form-control" id=""
