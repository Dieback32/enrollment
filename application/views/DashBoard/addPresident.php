...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header"><i class="fa fa fa-bars"></i> Add President</h3>
			</div>
		</div>
		<!-- page start-->
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						...
						?>
						<form method="POST" id="addAccount" action="<?php echo site_url(); ?>/DashBoard/setPresident"
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input name="role" type="hidden" value="president">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input value="<?php echo set_value('mi') ?>" maxlength="2" pattern="[A-Za-z]+"
