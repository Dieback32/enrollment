...
<section id="main-content">
  ...
  <div class="row">
		<div class="col-lg-12">
			<h3 class="page-header"><i class="fa fa fa-bars"></i> Add Accounting</h3>
		</div>
	</div>
      <!-- page start-->
      <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    ?>
                  <form method="POST" id="addAccount" action="<?php echo site_url(); ?>/DashBoard/setTreasurer" data-toggle="validator" class="form-horizontal" role="form">
			              <div class="col-md-6">
			                ...
			                <div class="form-group">
			                  <input name="role" type="hidden" value="treasurer">
			                </div>
			              </div>
			              <div class="col-md-6">
			              <div class="form-group">
