...
<section id="main-content">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa fa-bars"></i>New Student</h3>
    </div>
  </div>
      <!-- page start-->
      <div class="row">
                    ...
                    <form action="#" id="form" class="form-horizontal">
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input name="amount" placeholder="Amountl" pattern="[0-9]+([\.,][0-9]+)?" class="form-control" type="number" >
                          </div>
                        </div>
                      </div>
                    </form>
...
<script type="text/javascript">
  ...
  function add_reservation()
  {
    ...
    $('.modal-title').text('Add reservation'); // Set Title to Bootstrap modal title
  }
  ...
  function edit_reservation(id)
  {
    ...
    $.ajax({
      url : "<?php echo site_url('reservation/ajax_edit/')?>/" + id,
      type: "GET",
      dataType: "JSON",
  ...
  function delete_reservation(id)
  {
    if(confirm('Are you sure delete this data?'))
    {
      // ajax delete data to database
        $.ajax({
          url : "<?php echo site_url('reservation/ajax_delete')?>/"+id,
          type: "POST",
          dataType: "JSON",
          success: function(data)
          {
