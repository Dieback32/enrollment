...
<section id="main-content">
  ...
  <div class="row">
		<div class="col-lg-12">
			<h3 class="page-header"><i class="fa fa fa-bars"></i> Add Registrar</h3>
		</div>
	</div>
      <!-- page start-->
      <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    ?>
                  <form method="POST" id="addAccount" action="<?php echo site_url(); ?>/DashBoard/setRegistrar" data-toggle="validator" class="form-horizontal" role="form">
			              <div class="col-md-6">
			                ...
			                <div class="form-group">
			                  <input name="role" type="hidden" value="registrar">
			                </div>
			              </div>
			              <div class="col-md-6">
			              <div class="form-group">
			                ...
			                <div class="col-sm-10">
			                  <input value="<?php echo set_value('lname') ?>" type="text" pattern="[A-Za-z]+" name="lname" class="form-control" id="" placeholder="Lastname" required>
			                  <div class="help-block with-errors"></div>
			                </div>
			              </div>
			              <div class="form-group">
			                ...
			                <div class="col-sm-10">
			                  <input value="<?php echo set_value('fname') ?>" type="text" pattern="[A-Za-z]+" name="fname" class="form-control" id="" placeholder="First name" required>
			                  <div class="help-block with-errors"></div>
			                </div>
			              </div>
			              <div class="form-group">
			                ...
			                <div class="col-sm-10">
			                  <input value="<?php echo set_value('mi') ?>" maxlength="2" pattern="[A-Za-z]+" type="text" name="mi" class="form-control" id="" placeholder="MI" required>
			                  <div class="help-block with-errors"></div>
			                </div>
			              </div>
			              <div class="form-group">
				            ...
				            <div class="col-md-12">
				              <div class="form-group">
				                <div class="col-md-offset-3 col-md-6">
				                  <button type="submit" class="btn btn-primary <?php if($countRegistrar > 0) echo 'disabled'?>" style="width:100%" >Save</button>
				                </div>
				              </div>
				            </div>
				        </form>	 
